...
INSERT INTO `tb_bank` (`bankID`, `employeeID`, `bankName`, `accountNo`) VALUES
(1, 1214, 'Maybank', '1234567890124'),
(2, 1214, 'Bank Islam', '1234567890124'),
(3, 1214, 'Bank Islam', '1234567890124'),
(4, 1214, 'Bank Islam', '1234567890124'),
(5, 1214, 'Bank Islam', '1234567890124'),
(6, 1214, 'CIMB Bank', '1234567890124');
...
(322, '$2y$10$mZmjCC4BxI7v0BmcGr3UP.uNwPC/3ss3zBVSxgd378kdLHFOzilYa', 'user'),
...
CREATE TABLE `tb_loan` (
  ...
  `basicSalaryFile` mediumblob DEFAULT NULL,
  `netSalaryFile` mediumblob DEFAULT NULL,
...
(322, 'M19, JALAN RESAK, UNIVERSITY TEKNOLOGI MALAYSIA', '82000', 'Johor'),
(1214, 'JA7582, JALAN TEMAN 1, TAMAN TEMAN 77000 JASIN MELAKA', '77000', 'Melaka');
...
(322, 'UTM, MALAYSIA', 81310, 'Melaka'),
(1214, 'UTM', 81310, 'Johor');
...
--
ALTER TABLE `tb_bank`
  ADD CONSTRAINT `tb_bank_ibfk_1` FOREIGN KEY (`employeeID`) REFERENCES `tb_employee` (`employeeID`);
