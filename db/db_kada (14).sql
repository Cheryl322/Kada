...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2025 at 06:58 AM
...
--
-- Dumping data for table `tb_berhenti`
--

INSERT INTO `tb_berhenti` (`berhentiID`, `employeeID`, `reason`, `applyDate`, `approvalStatus`, `approveDate`, `rejectReason`) VALUES
(1, 4567, 'i fell tired, dont want to continue', '2025-02-10', 'Tolak', '2025-02-10', 'Sebab tidak mencukupi'),
(2, 9876, 'I dont want to continue', '2025-02-10', 'Tolak', '2025-02-10', 'Sebab tidak mencukupi'),
(3, 4567, 'hahaha', '2025-02-10', 'Lulus', '2025-02-10', NULL);
...
--
-- Dumping data for table `tb_member_status`
--

INSERT INTO `tb_member_status` (`statusID`, `employeeID`, `status`, `dateUpdated`) VALUES
(1, 5522, 'Aktif', '2025-02-10'),
(2, 322, 'Aktif', '2025-02-10'),
(3, 9876, 'Aktif', '2025-02-10'),
(4, 4567, 'Aktif', '2025-02-10');
...
--
ALTER TABLE `tb_berhenti`
  MODIFY `berhentiID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `tb_berhenti`
--
ALTER TABLE `tb_berhenti`
  ADD CONSTRAINT `tb_berhenti_ibfk_1` FOREIGN KEY (`employeeID`) REFERENCES `tb_member` (`employeeID`);
